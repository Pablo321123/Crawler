...
class DomainTest(unittest.TestCase):
    ...
    def test_domain(self):
        domain = Domain("https://pt.aliexpress.com", 10)
...
class SchedulerTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(len(arr_str_urls_seeds), len(
            self.scheduler.dic_url_per_domain), "Nao foi adicionado as sementes solicitadas")
    ...
    def test_can_fetch(self):
        ...
        obj_url_allowed = urlparse('https://www.terra.com.br/index.html') # a url sem .br está estragada
